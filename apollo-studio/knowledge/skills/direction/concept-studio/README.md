...
Detail the one direction the brief specifies — structure, hierarchy, media, motion, mobile behavior, assets, and risk, not only color. Produce alternatives only when the user asks, stating how many and why.
